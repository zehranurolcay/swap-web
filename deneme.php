...
<div class="mesajlasma-container">
    ...
    <div class="chat-container">
        <!-- Kullanıcı ismini gösteren başlık barı -->
...
<script>
    ...
    let selectedUserName = ''; // Seçilen kullanıcının ismi
    let socket;
    let offerId = null;
    ...
    function selectUser(userId, userName) {
        ...
        selectedUserName = userName; // Seçilen kullanıcının ismini al
        document.getElementById("chatHeader").textContent = selectedUserName; // Başlık barını güncelle
    ...
    socket.onmessage = function(event) {
        ...
        if (data.receiver_id == loggedUserId && data.sender_id == selectedUserId) {
            ...
            document.getElementById("messageContainer").appendChild(div);
             ...
             // Mesaj geldiğinde, mesaj alan kişinin mesaj kutusunu en alta kaydır
            const container = document.getElementById("messageContainer");
            container.scrollTop = container.scrollHeight;
        }
    };
